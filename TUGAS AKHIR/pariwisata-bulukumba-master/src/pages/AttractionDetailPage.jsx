  ...
  useEffect(() => {
    ...
    api.get(`/attractions/${id}`)
      ...
      .catch((err) => {
        ...
        setError('Gagal memuat data destinasi wisata');
        setLoading(false);
      });
      ...
      <div className="container mx-auto">
        <div className="text-center">
          <div className="max-w-md mx-auto">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">Destinasi Tidak Ditemukan</h3>
            <p className="text-gray-500 mb-4">
              {error || 'Destinasi wisata yang Anda cari tidak ditemukan atau telah dihapus.'}
            </p>
    ...
    <div className="container mx-auto">
      ...
      <div className="text-sm breadcrumbs mb-6">
        <ul>
          ...
          <li><Link to="/attractions" className="link link-hover">Destinasi</Link></li>
          <li className="text-gray-600">{data.nama_wisata}</li>
        </ul>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="relative">
            ...
            <div className="absolute top-4 left-4">
              <div className="badge badge-secondary badge-lg">Wisata</div>
            </div>
          </div>
        ...
        <div className="space-y-6">
            ...
            <div className="card-body p-4">
              ...
              {data.harga_tiket && (
                <div className="flex items-start space-x-3 mb-4">
                  ...
                  <div>
                    <p className="font-medium text-gray-900">Harga Tiket</p>
                    <p className="text-gray-600">{data.harga_tiket}</p>
                  </div>
                </div>
              )}
              ...
              {data.jam_operasional && (
                <div className="flex items-start space-x-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">{data.jam_operasional}</p>
                  </div>
                </div>
              )}
          ...
          <div className="space-y-3">
            <Link to="/attractions" className="btn btn-outline btn-block">
